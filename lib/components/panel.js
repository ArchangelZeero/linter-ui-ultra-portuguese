...
class Panel {
  ...
  constructor (props: Props) {
    ...
    this.subscriptions.add(
      atom.commands.add(this.element, {
        'linter-ui-ultra-portuguese:open-selected-entry': this.didOpenSelected,
  ...
  readAfterUpdate () {
    ...
    const descEl = this.element.querySelector(
      `.panel-row-selected + .panel-message-description`
    )
    if (descEl != null) {
  ...
  render () {
    ...
    return (
      <div
        className={cx('linter-ui-ultra-portuguese panel', {
