...
class TooltipDelegate {
  ...
  constructor() {
    ...
    this.subscriptions.add(
      atom.config.observe('linter-ui-ultra-portuguese.showProviderName', showProviderName => {
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {
        'linter-ui-ultra-portuguese:expand-tooltip': event => {
          if (this.expanded) {
            return
          }
          this.expanded = true
          ...
          if (event.originalEvent && event.originalEvent.isTrusted) {
            ...
            document.body.addEventListener('keyup', function eventListener() {
              ...
              atom.commands.dispatch(atom.views.getView(atom.workspace), 'linter-ui-ultra-portuguese:collapse-tooltip')
            })
          }
        },
        'linter-ui-ultra-portuguese:collapse-tooltip': () => {
          this.expanded = false
