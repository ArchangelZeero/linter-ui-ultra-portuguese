...
class TooltipDelegate {
  ...
  constructor() {
    ...
    this.subscriptions.add(
      atom.config.observe('linter-ui-ultra.showProviderName', showProviderName => {
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {
        'linter-ui-ultra:expand-tooltip': event => {
          if (this.expanded) {
            return
          }
          this.expanded = true
          ...
          if (event.originalEvent && event.originalEvent.isTrusted) {
            ...
            document.body.addEventListener('keyup', function eventListener() {
              ...
              atom.commands.dispatch(atom.views.getView(atom.workspace), 'linter-ui-ultra:collapse-tooltip')
            })
          }
        },
        'linter-ui-ultra:collapse-tooltip': () => {
          this.expanded = false
