...
class Editor {
  ...
  constructor (textEditor: TextEditor, initialMessages: LinterMessage[]) {
    ...
    this.subscriptions.add(
      atom.config.observe('linter-ui-ultra-portuguese.showTooltip', showTooltip => {
    ...
    this.subscriptions.add(
      atom.config.observe('linter-ui-ultra-portuguese.tooltipFollows', tooltipFollows => {
    ...
    this.textEditor.decorateMarkerLayer(this.textEditor.selectionsMarkerLayer, {
      gutterName: 'linter-ui-ultra-portuguese',
      type: 'gutter',
