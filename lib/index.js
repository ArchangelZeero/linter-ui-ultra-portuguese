...
function activate () {
  ...
  editorRegistry = new EditorRegistry(messagesByFile)
  messageCountsBySeverity = { warning: 0, error: 0, info: 0 }

  // Register commands attached to the workspace
  atom.commands.add('atom-workspace', {
    'linter-ui-ultra-portuguese:toggle-panel': togglePanel(true),
    'linter-ui-ultra-portuguese:move-to-next': moveToNext,
    'linter-ui-ultra-portuguese:move-to-previous': moveToPrevious
  })
  ...
  return {
    ...
    render: (difference: MessagesPatch) => {
      ...
      for (const message of difference.added) {
        ...
        editorRegistry.addMessage(message)
      }
      ...
      for (const message of difference.removed) {
        ...
        editorRegistry.removeMessage(message)
      }
